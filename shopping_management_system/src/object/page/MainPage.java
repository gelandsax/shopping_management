...
public final class MainPage extends ScannerChoice{
    ...
    public static void MaintenancePage(){
        ...
        do{
            ...
            System.err.println("输入有误 ！");
            System.out.println("重新输入或者按0返回上一级菜单。");
        }while(true);
    }
                ...
                switch (info) {
                    ...
                    case 1:
                        ...
                        while (loginTimes!=0) {
                            ...
                            if (salesManInfo == null || salesManInfo.isEmpty()){//没有此用户的情况
                ...
                switch (gid)
                {
                    ...
                    default:
                        ...
                        }else
                        {
                            ...
                            do
                            {
                                int choicegoodsNum = ScannerNumber();//获取用户要购买的数量
