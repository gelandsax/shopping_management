...
import object.page.GoodsPage;
import object.page.MainPage;
import object.page.SalesManPage;



public class ScannerChoice {
    //从键盘获得商品价格
    public static double ScannerPrice(){
        double price = 0.00;
        do{
            Scanner sc = new Scanner(System.in);
            System.out.print("保留小数点后两位，请输入商品价格：");
            String info = sc.next();
